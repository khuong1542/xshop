...
$categories = executeQuery($getListProductQuery);
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="<?php echo BASE_ADMIN.'categories/add-form.php' ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <label class="custom-control custom-checkbox p-0 m-0 pointer "
                                                    ...
                                                    <input type="checkbox" class="custom-control-input toggle-class"
                                                        data-id="<?= $category['id'] ?>" data-on="On" name="my_checkbox"
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a onclick="return Delete()"
                                                    href="<?php echo BASE_ADMIN . 'categories/delete.php'?>?id=<?php echo $category['id']; ?>"
